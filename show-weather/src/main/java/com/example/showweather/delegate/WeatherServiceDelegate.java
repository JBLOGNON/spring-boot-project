...
public class WeatherServiceDelegate {
    ...
    public String getVilleByName(String name) {
        String response = restTemplate.exchange("http://localhost:8080/getVilleByName/{name}",
    ...
    public String getVilleByZipCode(String zip) {
        String response = restTemplate.exchange("http://localhost:8080/getVilleByZipCode/{zip}",
